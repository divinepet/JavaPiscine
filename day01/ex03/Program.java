public class Program {
    public static void main(String[] args) {
        ...
        Transaction trans = new Transaction(user1, user2, 0, 100);
        Transaction trans2 = new Transaction(user1, user2, 0, 100);
        Transaction trans3 = new Transaction(user1, user2, 0, 100);
        list.add(trans);
        list.add(trans3);
        try {
